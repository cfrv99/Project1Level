...
namespace StepCourseProject.Migrations
{
    ...
    [Migration("20200113132839_many_to_manyPost")]
    partial class many_to_manyPost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StepCourseProject.Entites.FreelancerPost", b =>
                {
                    b.Property<int>("PostId");

                    b.Property<string>("FeelancerId");

                    b.Property<string>("FreelancerId");

                    b.HasKey("PostId", "FeelancerId");

                    b.HasIndex("FeelancerId");

                    b.ToTable("FreelancerPosts");
                });
            ...
            modelBuilder.Entity("StepCourseProject.Entites.FreelancerPost", b =>
                {
                    b.HasOne("StepCourseProject.Entites.AppUser", "Freelancer")
                        .WithMany("FreelancerPosts")
                        .HasForeignKey("FeelancerId")
                        .OnDelete(DeleteBehavior.Cascade);
